  ...
  <div id="app">
      ...
      <el-table :data="tableData" border style="width: 100%" stripe>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button @click="toRole(scope.$index, scope.row)" type="text" size="small">角色</el-button>
            <el-button
    ...
    <el-dialog :visible.sync="dialog.show">
      ...
      >
        ...
        <el-form-item label="密码">新增用户的默认密码为default123456</el-form-item>
      </el-form>
    ...
    <el-dialog :visible.sync="roleDialog.show">
      <div slot="title" class="header-title">
...
export default Vue.extend({
  ...
  methods: {
    ...
    toDelete(index: number, row: any) {
      let t = this;
      Vue.axios
        .post("/user/deleteByUsername/" + row.username)
        .then(function(res) {
          let data = res.data;
          if (data.code == 200) {
            t.$message({
    ...
    showDialogForm(username: string) {
      let t = this;
      Vue.axios
        .post("/user/findUserByUsername/" + username)
        .then(function(res) {
          let data = res.data;
          if (data.code == 200) {
            t.dialog.form = {
